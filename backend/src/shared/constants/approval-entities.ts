 ...
 */
export type ApprovalEntityName = typeof APPROVAL_ENTITIES[keyof typeof APPROVAL_ENTITIES];
 ...
 */
export function getApprovalEntityName(moduleName: string): ApprovalEntityName | string {
