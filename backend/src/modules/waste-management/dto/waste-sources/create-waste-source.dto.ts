...
import { IsString, IsNotEmpty, IsOptional, IsBoolean, IsEmail, ValidateIf } from 'class-validator';
...
export class CreateWasteSourceDto {
  ...
  @ApiProperty({ required: false }) @ValidateIf((o) => o.email !== '') @IsEmail() @IsOptional() email?: string;
