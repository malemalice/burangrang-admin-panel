...
export class DispatchOrdersController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The dispatch order has been successfully created.',
  ...
  @ApiResponse({
    status: 200,
    description: 'Return all dispatch orders.',
    type: [DispatchOrderDto],
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  findAll(
  ...
  @ApiResponse({
    status: 200,
    description: 'Return the dispatch order.',
    type: DispatchOrderDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The dispatch order has been successfully updated.',
    type: DispatchOrderDto,
  })
  @ApiResponse({ status: 400, description: 'Bad Request' })
  @ApiResponse({ status: 404, description: 'Dispatch order not found' })
  ...
  @ApiResponse({
    status: 200,
    description: 'The dispatch order has been successfully deleted.',
  })
  @ApiResponse({ status: 404, description: 'Dispatch order not found' })
