...
export class UpdateRiskMatrixDto {
  @ApiProperty({ description: 'The likelihood level as uppercase alphabet (A-Z)', example: 'A', required: false })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({ description: 'The numeric consequence level (1-99)', minimum: 1, maximum: 99, required: false })
  @IsInt()
  @Min(1)
  @Max(99)
  @IsOptional()
