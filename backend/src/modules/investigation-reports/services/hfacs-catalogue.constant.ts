...
export const HFACS_CATALOGUE: Record<InvestigationCauseSectionEnum, HfacsTier1[]> = {
  LATENT_FAILURE: HFACS_LATENT_FAILURE,
  ACTIVE_FAILURE: HFACS_ACTIVE_FAILURE,
};
...
export const HFACS_LOOKUP: Map<string, HfacsLookupEntry> = (() => {
  ...
  for (const [section, tiers] of Object.entries(HFACS_CATALOGUE) as Array<
    [InvestigationCauseSectionEnum, HfacsTier1[]]
  >) {
