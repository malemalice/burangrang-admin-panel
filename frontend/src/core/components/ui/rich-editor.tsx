    ...
    editorProps: {
      attributes: {
        class: cn(
          ...
          // Ensure formatting is visually obvious inside the editor (even when typography defaults are subtle).
          '[&_h1]:text-3xl [&_h1]:font-bold [&_h1]:tracking-tight [&_h1]:mt-6 [&_h1]:mb-3 ' +
            '[&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:mt-5 [&_h2]:mb-3 ' +
