...
import { ArrowLeft, Loader2, Pencil, Calendar, User, Phone, Mail, FileText, Info } from 'lucide-react';
...
import { WasteSource } from '../../types/waste-management.types';
import { formatDate } from '@/core/utils/date';

export default function WasteSourceDetailPage() {
    const { id } = useParams<{ id: string }>();
    const navigate = useNavigate();
    const [data, setData] = useState<WasteSource | null>(null);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                toast.error('Failed to fetch waste source details');
            ...
            <PageHeader
                ...
                actions={
                    <div className="flex gap-2">
                        ...
                        <Button onClick={() => navigate(`/waste-management/waste-sources/${id}/edit`)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="md:col-span-2">
                    <CardHeader>
                        ...
                        <CardDescription>Basic details about the waste source</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="font-medium">{data.sourceType}</p>
                            </div>
                            <div className="space-y-1">
