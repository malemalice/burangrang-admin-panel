...
const mapProductDtoToProduct = (productDto: ProductDTO): Product => {
  return {
    ...
    isFreePrice: productDto.isFreePrice ?? false,
    minFreePrice: productDto.minFreePrice ? Number(productDto.minFreePrice) : undefined,
    maxFreePrice: productDto.maxFreePrice ? Number(productDto.maxFreePrice) : undefined,
    sku: productDto.sku,
...
const mapProductToCreateDto = (product: Partial<Product>): CreateProductDTO => {
  return {
    ...
    minFreePrice: product.minFreePrice,
    maxFreePrice: product.maxFreePrice,
    sku: product.sku || '',
