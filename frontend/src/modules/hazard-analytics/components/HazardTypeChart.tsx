...
import type { HazardTypeData } from '../types/hazard-analytics.types';

const BAR_COLOR = '#3B82F6';

interface HazardTypeChartProps {
  data: HazardTypeData[];
}

export function HazardTypeChart({ data }: HazardTypeChartProps) {
  const chartData = [...data].sort((a, b) => b.count - a.count);

  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg">Type of Hazard</CardTitle>
      </CardHeader>
      <CardContent>
