...
const mapPPEWithdrawalItemDtoToPPEWithdrawalItem = (itemDto: PPEWithdrawalItemDTO): PPEWithdrawalItem => ({
    ...
    stockItemEquipmentName: (itemDto as any).stockItemEquipmentName || null,
    stockItemEquipmentType: (itemDto as any).stockItemEquipmentType || null,
    stockItemEquipmentSize: (itemDto as any).stockItemEquipmentSize || null,
...
const mapPPEWithdrawalDtoToPPEWithdrawal = (withdrawalDto: PPEWithdrawalDTO): PPEWithdrawal => ({
    ...
    departmentName: (withdrawalDto as any).departmentName || null,
