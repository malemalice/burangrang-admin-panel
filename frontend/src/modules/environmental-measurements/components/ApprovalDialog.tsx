    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Review and submit your approval decision for this environmental measurement.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem value={ApprovalStatus.APPROVED} id="em-approved" />
                <Label htmlFor="em-approved" className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500" />
                  Approve
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value={ApprovalStatus.REJECTED} id="em-rejected" />
                <Label htmlFor="em-rejected" className="flex items-center gap-2">
