...
import type { CaseStatus } from '../types/security-team.types';

const OPEN_COLOR = '#EF4444';
const CLOSED_COLOR = '#B45309';

interface IncidentCaseStatusChartProps {
  data: CaseStatus;
  periodLabel?: string;
}

export function IncidentCaseStatusChart({ data, periodLabel }: IncidentCaseStatusChartProps) {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-lg">
          Incident Case Status{periodLabel ? ` ${periodLabel}` : ''}
        </CardTitle>
      </CardHeader>
      <CardContent>
