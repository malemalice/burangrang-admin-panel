...
| (historical) | Three-tier authorization: role / permission / data-scope as separate guards | Mixing them produces unmaintainable access logic ([principles §2](../../principles.md)) | [../trd-authorization.md](../trd-authorization.md) |
| (historical) | Inspection approval migration to configurable workflow | Approval lines must be configurable per Master Approval config, never hardcoded | [../trd-inspection-approval.md](../trd-inspection-approval.md) |
