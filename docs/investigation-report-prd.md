...
| NFR-006 | **HFACS catalogue:** The full cause catalogue (Section H & I items, their keys, labels, and tier hierarchy) SHALL be maintained as application-level constants (TypeScript/enum), NOT as database master data. This avoids migration risk when the form is revised. |
