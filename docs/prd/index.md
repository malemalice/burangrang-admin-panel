...
| File | Contents |
|---|---|
| [problem-goals.md](./problem-goals.md) | Problem statement, goals, non-goals |
| [personas.md](./personas.md) | User personas (admin, dept head, security, employees, contractors) |
| [features.md](./features.md) | Feature map across all domains |
